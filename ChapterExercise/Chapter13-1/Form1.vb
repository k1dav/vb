Public Class Form1
    ...
    Private Sub 第一張ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles 第一張ToolStripMenuItem1.Click
        num = 0
        ShowPic()
    End Sub

    Private Sub 上一張ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles 上一張ToolStripMenuItem1.Click
        num -= 1   ' num圖片索引編號減1，表示顯示上一張
        ' 若num圖片索引編號小於1，則另num由最後一張開始
        If num < 0 Then
            num = photo.GetUpperBound(0)
    ...
    Private Sub 下一張ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles 下一張ToolStripMenuItem1.Click
        num += 1  ' num圖片索引編號加1，表示顯示下一張
        ' 若num圖片索引編號大於最後一張圖的索引編號
        ' 則另num為0，表示由第一張開始顯示
        If num > photo.GetUpperBound(0) Then
    ...
    Private Sub 最末張ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles 最末張ToolStripMenuItem1.Click
        ' 另num由最後一張索引編號開始
        num = photo.GetUpperBound(0)
        ShowPic()
